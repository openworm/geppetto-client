  ...
  var StackViewerComponent = createClass({
    ...
    getInitialState: function () {
      return {
        ...
        imageX: 10240,
        imageY: 10240,
        fxp: function () { if (this.props.config != undefined && this.props.config.subDomains != undefined && this.props.config.subDomains.length > 4) {return JSON.parse(this.props.config.subDomains[4][0])}; return [511, 255, 108];},
        pit: 0,
        yaw: 0,
        rol: 0,
        scl: 1.0,
        ...
        label: [],
        id: [],
        tempId: function () { if (this.props.config != undefined && this.props.config.subDomains != undefined && this.props.config.subDomains.length > 1) {return this.props.config.subDomains[1]}; return []},
        tempName: function () { if (this.props.config != undefined && this.props.config.subDomains != undefined && this.props.config.subDomains.length > 2) {return this.props.config.subDomains[2]}; return []},
        tempType: function () { if (this.props.config != undefined && this.props.config.subDomains != undefined && this.props.config.subDomains.length > 3) {return this.props.config.subDomains[3]}; return []},
        plane: null,
        initalised: false,
        slice: false
      };
